...
// Force Node runtime + dynamic server rendering
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description:
      "Explore the NanoSoft IT Blog for insights on managed IT services, UI development, and enterprise technology trends.",
    keywords:
      "UI development blog, IT services, NanoSoft IT, web development, React, Next.js",
  };
}
